...
formStatus:{submitting:"Sending your inquiry...",submittingButton:"Sending...",success:"Thank you. Your request has been sent successfully.",error:"We could not send your request right now. Please email hello@cell-performance.de."},
...
formStatus:{submitting:"Ihre Anfrage wird gesendet...",submittingButton:"Wird gesendet...",success:"Vielen Dank. Ihre Anfrage wurde erfolgreich versendet.",error:"Ihre Anfrage konnte gerade nicht gesendet werden. Bitte schreiben Sie an hello@cell-performance.de."},
footerHeadings:["","Instagram"],
...
formStatus:{submitting:"Enviando su solicitud...",submittingButton:"Enviando...",success:"Gracias. Su solicitud se ha enviado correctamente.",error:"No hemos podido enviar su solicitud en este momento. Escribanos a hello@cell-performance.de."},
footerHeadings:["","Instagram"],
...
shopCards:[
["Compléments","Formulations ciblées pour le soutien mitochondrial, la santé cellulaire et des concepts de pratique orientés performance.","Découvrir"],
["Infusions","Solutions d'infusion spécialisées pour un usage clinique structuré, incluant le soutien mitochondrial et des concepts d'application adaptés à la pratique.","Découvrir"],
["Savoir-faire médical","Ressources pédagogiques et orientation médicale structurée autour de la thérapie cellulaire bionique, des protocoles de santé cellulaire et de leur intégration en pratique clinique.","Découvrir"]
],
eventLabel:"Événement",
eventTitle:"Longevity Lab Mallorca 2026",
eventDate:"20 juin 2026",
eventHeroTitle:"Longevity Lab<br>Mallorca",
eventLocation:"Mallorca, Espagne · Estadi Mallorca Son Moix & Mallorca Country Club",
eventDesc:"En tant que sponsor officiel du RCD Mallorca et partenaire du Mallorca Country Club, Global Hub for Cell Performance réunit des professionnels autour de la santé cellulaire, de la prévention et de la médecine de la performance. Le programme associe éducation médicale, échanges interdisciplinaires et perspectives fondées sur les preuves pour la pratique clinique et appliquée.",
eventBtns:["Réserver votre place"],
timeline:[
["Séminaire Longévité & Performance","Estadi Mallorca Son Moix, stade du RCD Mallorca. Présentations scientifiques sur la thérapie cellulaire bionique, les stratégies de longévité et la médecine préventive, dirigées par le Dr Kay Bredehorst."],
["Tournoi ATP & networking","Mallorca Country Club, Vanda Pharmaceuticals Mallorca Championships. Tennis de haut niveau et networking exclusif à Santa Ponsa."],
["Cocktail de bienvenue","Mallorca Country Club, Avinguda del Golf 20, 07180 Santa Ponsa. Profitez d'un cocktail de bienvenue pour arriver, échanger et apprécier l'atmosphère avant le programme du soir."],
["Événement du soir & dîner","Une soirée exclusive favorisant les échanges personnels avec des médecins, spécialistes de la médecine du sport et décideurs du monde de l'entreprise."]
],
gallery:[
["Soirée au Mallorca Country Club","Networking, dîner et conversations soigneusement organisées dans un cadre premium à Santa Ponsa."],
["Tournoi ATP & networking","Une atmosphère de tennis de niveau mondial dans le cadre des Vanda Pharmaceuticals Mallorca Championships."]
],
expertsLabel:"Direction médicale",
expertsTitle:"Dr. Kay Bredehorst",
expertRole:"Directeur",
expertDesc:"Fondateur et directeur médical de Cell Education, développeur des compléments ONE Life Sciences, expert reconnu en thérapie cellulaire bionique et longévité, et conseiller de nombreuses organisations du sport professionnel d'élite.",
badges:["Thérapie cellulaire bionique","Longévité","Sport de haut niveau"],
networkLabel:"B2B",
networkTitle:"Le réseau Global Hub",
networkFeatures:[
["Partenaires vérifiés","Accès pour les médecins, praticiens, professionnels de santé et entreprises du secteur santé."],
["Protocoles exclusifs","Protocoles thérapeutiques validés cliniquement et recommandations pratiques de dosage."],
["Formation médicale","Formation en médecine cellulaire, disponible en ligne et en présentiel."],
["Opportunités B2B","Conditions exclusives, accès au réseau et nouvelles opportunités de partenariat pour cabinets, cliniques et entreprises de santé."]
],
partnersLabel:"Partenaires",
partnersTitle:"Partenaires sélectionnés dans l'écosystème Global Hub",
partnersText:"Le Global Hub réunit des partenaires issus de l'éducation, du clinique et du sport dans un contexte soigneusement curé. Cela crée un point d'entrée plus clair pour les échanges professionnels, l'orientation produit et la participation aux événements.",
sportLabel:"Partenaire officiel du RCD Mallorca",
sportTitle:"Sport & médecine cellulaire",
sportHead:'RCD Mallorca',
sportText:"En tant que sponsor officiel du RCD Mallorca, nous soutenons la performance d'élite au plus haut niveau international. Ce partenariat reflète des valeurs communes telles que l'ambition, le professionnalisme et le développement continu. Grâce à ce sponsoring, nous nous engageons dans l'univers du football professionnel international et contribuons à un environnement où la haute performance peut s'épanouir.",
sportBtn:"Visiter le RCD Mallorca",
officialLabel:"Partenaires officiels",
officialBodies:[
"Avec Burg-Apotheke comme partenaire, nous développons de nouvelles applications d'infusion disponibles exclusivement pour nos participants. Cette collaboration associe transfert de connaissances médicales et solutions d'infusion innovantes, conçues individuellement pour votre cabinet ou votre clinique.",
...
roleOptions:["Veuillez choisir","Médecin","Praticien","Pharmacien / pharmacie","Professionnel de santé","Entreprise du secteur santé","Médecine du sport / performance","Autre"],
interestOptions:["Veuillez choisir","Longevity Lab Mallorca 2026","Global Hub Network","Accès boutique / produits","Partenariat / coopération"],
messagePlaceholder:"Quel est précisément votre intérêt ?",
...
formStatus:{submitting:"Envoi de votre demande...",submittingButton:"Envoi...",success:"Merci. Votre demande a été envoyée avec succès.",error:"Nous ne pouvons pas envoyer votre demande pour le moment. Veuillez écrire à hello@cell-performance.de."},
footerHeadings:["","Instagram"],
...
headlineText:"Mezinárodní síť pro buněčné zdraví, která propojuje lékaře, výzkumníky a terapeuty po celém světě.",
headlineCta:"Připojit se k síti",
cards:["O Cell Education","Naši partneři"],
textblock:'Prostřednictvím sítě Global Hub Network propojujeme lékaře z celého světa v oblasti buněčné medicíny, longevity a terapeutických inovací.',
textblockCta:"Požádat o přístup",
shopLabel:"Obchod",
shopTitle:"Produkty a řešení",
shopCards:[
["Doplňky stravy","Cílené formulace pro mitochondriální podporu, buněčné zdraví a výkonnostně orientované koncepty praxe.","Prozkoumat"],
["Infuze","Specializovaná infuzní řešení pro strukturované klinické použití včetně mitochondriální podpory a prakticky zaměřených aplikačních konceptů.","Prozkoumat"],
["Medicínské know-how","Vzdělávací materiály a strukturované medicínské vedení k bionické buněčné terapii, protokolům buněčného zdraví a jejich integraci do klinické praxe.","Prozkoumat"]
],
eventLabel:"Událost",
eventTitle:"Longevity Lab Mallorca 2026",
eventDate:"20. června 2026",
eventHeroTitle:"Longevity Lab<br>Mallorca",
eventLocation:"Mallorca, Španělsko · Estadi Mallorca Son Moix & Mallorca Country Club",
eventDesc:"Jako oficiální sponzor RCD Mallorca a partner Mallorca Country Club spojuje Global Hub for Cell Performance odborníky kolem buněčného zdraví, prevence a výkonnostní medicíny. Program propojuje medicínské vzdělávání, mezioborovou výměnu a přístupy založené na důkazech pro klinickou i aplikovanou praxi.",
eventBtns:["Rezervovat místo"],
timeline:[
["Seminář Longevity & Performance","Estadi Mallorca Son Moix, stadion RCD Mallorca. Odborné prezentace o bionické buněčné terapii, strategiích longevity a preventivní medicíně pod vedením Dr. Kaye Bredehorsta."],
["ATP turnaj & networking","Mallorca Country Club, Vanda Pharmaceuticals Mallorca Championships. Špičkový tenis a exkluzivní networking v Santa Ponsa."],
["Uvítací drink","Mallorca Country Club, Avinguda del Golf 20, 07180 Santa Ponsa. Užijte si uvítací drink, přijeďte v klidu, navazujte kontakty a nalaďte se na atmosféru před večerním programem."],
["Večerní akce & večeře","Exkluzivní večer pro osobní výměnu s lékaři, specialisty sportovní medicíny a lídry z byznysu."]
],
gallery:[
["Večerní akce v Mallorca Country Club","Networking, večeře a kurátorované rozhovory v prémiovém prostředí v Santa Ponsa."],
["ATP turnaj & networking","Atmosféra světového tenisu v rámci Vanda Pharmaceuticals Mallorca Championships."]
],
expertsLabel:"Medicínské vedení",
expertsTitle:"Dr. Kay Bredehorst",
expertRole:"Ředitel",
expertDesc:"Zakladatel a Medical Director Cell Education, vývojář doplňků ONE Life Sciences, uznávaný expert na bionickou buněčnou terapii a longevity a poradce mnoha organizací vrcholového profesionálního sportu.",
badges:["Bionická buněčná terapie","Longévita","Vrcholový sport"],
networkLabel:"B2B",
networkTitle:"Síť Global Hub",
networkFeatures:[
["Ověření partneři","Přístup pro lékaře, praktiky, zdravotnické odborníky a firmy ze zdravotnického sektoru."],
["Exkluzivní protokoly","Klinicky validované terapeutické protokoly a praktická doporučení dávkování."],
["Medicínské vzdělávání","Vzdělávání v oblasti buněčné medicíny, dostupné online i prezenčně."],
["B2B příležitosti","Exkluzivní podmínky, přístup do sítě a nové partnerské příležitosti pro praxe, kliniky a zdravotnické firmy."]
],
partnersLabel:"Partneři",
partnersTitle:"Vybraní partneři v ekosystému Global Hub",
partnersText:"Global Hub spojuje vzdělávací, klinické a sportovně zaměřené partnery v jednom kurátorovaném kontextu. Vytváří tak jasnější vstupní bod pro profesní výměnu, orientaci v produktech a účast na událostech.",
sportLabel:"Oficiální partner RCD Mallorca",
sportTitle:"Sport a buněčná medicína",
sportHead:'RCD Mallorca',
sportText:"Jako oficiální sponzor RCD Mallorca podporujeme elitní výkon na nejvyšší mezinárodní úrovni. Partnerství odráží společné hodnoty, jako jsou ambice, profesionalita a neustálý rozvoj. Díky tomuto sponzoringu působíme v prostředí mezinárodního profesionálního fotbalu a podporujeme kontext, v němž může vrcholový výkon prosperovat.",
sportBtn:"Navštívit RCD Mallorca",
officialLabel:"Oficiální partneři",
officialBodies:[
"Společně s Burg-Apotheke vyvíjíme nové infuzní aplikace dostupné exkluzivně pro naše účastníky. Tato spolupráce spojuje přenos medicínských znalostí a inovativní infuzní řešení navržená individuálně pro vaši praxi nebo kliniku.",
...
roleOptions:["Prosím vyberte","Lékař","Praktik","Lékárník / lékárna","Zdravotnický odborník","Firma ze zdravotnického sektoru","Sportovní medicína / performance","Jiné"],
interestOptions:["Prosím vyberte","Longevity Lab Mallorca 2026","Global Hub Network","Přístup do obchodu / produkty","Partnerství / spolupráce"],
messagePlaceholder:"O co máte konkrétně zájem?",
...
formStatus:{submitting:"Odesílání vaší poptávky...",submittingButton:"Odesílání...",success:"Děkujeme. Vaše poptávka byla úspěšně odeslána.",error:"Vaši poptávku se teď nepodařilo odeslat. Napište prosím na hello@cell-performance.de."},
footerHeadings:["","Instagram"],
...
formStatus:{submitting:"Wysylanie zapytania...",submittingButton:"Wysylanie...",success:"Dziekujemy. Twoje zapytanie zostalo pomyslnie wyslane.",error:"Nie udalo sie teraz wyslac zapytania. Napisz prosze na hello@cell-performance.de."},
footerHeadings:["","Instagram"],
...
function applyLanguage(lang){
  ...
  document.querySelector('.register-form__note').innerHTML=`${t.formNote} <a class="register-form__email" href="mailto:hello@cell-performance.de">hello@cell-performance.de</a>.`;
